...
public class Level {
	...
	public Enemy getRandomEnemy(Model m, int x, int y, Tile tile) {
		...
		Enemy returnEnemy = new Enemy(m, x, y, enemySprite, speed, tile, 10, 1);
		return returnEnemy;
	}
	...
	public Pet getRandomPet(Model m, int x, int y, Tile tile) {
		...
		//TODO mettre la vraie vie
		Pet returnPet = new Pet(m, x, y, petSprite, speed, tile, 10,1);
		return returnPet;
	}
	...
	public Boss getBoss(Model m, int x, int y, Tile tile) {
		...
		//TODO mettre la vraie vie
		Boss returnBoss = new Boss(m, x, y, bossSprite, speed, tile, 10, 3);
		return returnBoss;
	}
